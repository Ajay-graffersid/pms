...
Route::get('/de', function () {
    ...
    if ($companies) {
        foreach ($companies as $company) {
           $month= DB::table('month_leves')->get();
         
            $employees = EmployeeDetails::where('company_id', $company->id)->get();
           

            foreach ($employees as $key => $employee) {
               // echo '<pre>';print_r($employee->joining_date);die;
...
Route::group(['middleware' => 'auth'], function () {
            ...
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('employees/active-employees', ['uses' => 'ManageEmployeesController@activeEmployees'])->name('employees.activeEmployees');
                        Route::get('employees/inactive-employees', ['uses' => 'ManageEmployeesController@inactiveEmployees'])->name('employees.inactiveEmployees');
                        Route::get('employees/batch-employees', ['uses' => 'ManageEmployeesController@benchEmployees'])->name('employees.batchEmployees');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::resource('expenses-recurring', 'ManageExpensesRecurringController');
                         ...
                         Route::post('office-expenses/change-status', ['uses' => 'ManageOfficeExpensesController@changeStatus'])->name('office-expenses.changeStatus');
                        Route::get('office-expenses/export/{startDate}/{endDate}/{status}/{employee}', ['uses' => 'ManageOfficeExpensesController@export'])->name('office-expenses.export');
                        Route::post('estimates/send-estimate/{id}', ['uses' => 'ManageEstimatesController@sendEstimate'])->name('estimates.send-estimate');
                        Route::resource('office-expenses', 'ManageOfficeExpensesController');
                        
                       // Route::get('office-exp-status/{id?}/{status?}', ['uses' => 'ManageOfficeExpensesController@status_change']);
        ...
        function () {
            ...
            Route::group(
                ...
                function () {
                    ...
                    //Office Expenses routes 
                    Route::get('office-expenses/data', ['uses' => 'MemberOfficeExpenseController@data'])->name('office-expenses.data');
                    Route::resource('office-expenses', 'MemberOfficeExpenseController');
    ...
    Route::get('office-exp-status/{id?}/{status?}', ['uses' => 'admin\ManageOfficeExpensesController@status_change']);
   // Route::get('demo', ['uses' =>'admin\ManageExpensesController@demo']);
    Route::get('office-expenses', ['uses' =>'admin\ManageExpensesController@demo']);

 // Route::get('member/batch-employees', ['uses' => 'Admin\ManageEmployeesController@batchEmployees']);
  //Route::get('admin/employees/batch-employees', ['uses' => 'Admin\ManageEmployeesController@batchEmployees'])->name('employees.batchEmployees');
  //Route::get('free-employees', ['uses' => 'Admin\ManageEmployeesController@mem_freeEmployees']);
  Route::get('free-employees', ['uses' => 'Member\MemberOfficeExpenseController@mem_freeEmployees']);
