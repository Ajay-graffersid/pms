                ...
                <div class="tab-pane" id="leaves">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="basic-list">
                                <?php //echo '<pre>'; print_r($employeeLeavesQuota);die; ?>
                              {{--  @forelse($leaveTypes as $key=>$leaveType) --}}
                                    {{--@if (isset($employeeLeavesQuota[$key]) && $employeeLeavesQuota[$key]->no_of_leaves > 0) --}}
                                    <?php $le=DB::table('new_employee_leave_quotas')->where('user_id',$id)->first();
                                  //  echo '<pre>';print_r($le->sl);die;
                                    ?>      
                                    <li>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                  Cl  {{-- ucfirst($leaveType->type_name) --}}---{{$le->cl}}
                                                </div>
                                                <div class="col-sm-6 text-right">
                                                    <span class="label-{{-- $leaveType->color --}} label">
                                                       {{$le->cl}}
                                                    </span>
                                                </div>                                           
                                            </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-sm-6">
                                                  Sl  {{-- ucfirst($leaveType->type_name) --}} ---{{$le->sl}}
                                                </div>
                                                <div class="col-sm-6 text-right">
                                                    <span class="label-{{-- $leaveType->color --}} label">
                                                   11111
