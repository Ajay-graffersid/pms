...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right bg-title-right">
            <a href="{{ route('member.office-expenses.create') }}" class="btn btn-outline btn-success btn-sm">@lang('modules.officeExpenses.addExpense') <i class="fa fa-plus" aria-hidden="true"></i></a>
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('member.office-expenses.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
    ...
    function loadTable(){
        ...
        table = $('#invoice-table').dataTable({
            ...
            ajax: '{!! route('member.office-expenses.data') !!}?startDate=' + startDate + '&endDate=' + endDate + '&status=' + status + '&employee=' + employee,
            order: [[ 0, "desc" ]],
            language: {
