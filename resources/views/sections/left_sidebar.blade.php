            ...
            @if(in_array('employees', $modules) || in_array('attendance', $modules) || in_array('holidays', $modules) || in_array('leaves', $modules))
                <li><a href="{{ route('admin.employees.index') }}" class="waves-effect
                    ...
                    <ul class="nav nav-second-level {{ request()->is('admin/leave*') ? 'collapse in' : '' }}">
                        ...
                        <li><a href="{{ route('admin.employees.index') }}" class="waves-effect
                            {{ request()->is('admin/leave*') ? 'active' : '' }}
                            "><i class="ti-user fa-fw"></i> <span class="hide-menu">Employee <span class="fa arrow"></span> </span></a>
                            <ul class="nav nav-second-level {{ request()->is('admin/leave*') ? 'collapse in' : '' }}">
                                <li class="left-menu-fix"><a href="{{ route('admin.employees.index') }}">@lang('app.menu.employeeList')</a></li>                           
                                <li class="left-menu-fix"><a href="{{ route('admin.employees.activeEmployees') }}">@lang('app.menu.activeEmployees')</a></li>
                                <li class="left-menu-fix"><a href="{{ route('admin.employees.inactiveEmployees') }}">@lang('app.menu.inactiveEmployees')</a></li>
                                <li class="left-menu-fix"><a href="{{ route('admin.employees.batchEmployees') }}">@lang('app.menu.batchEmployees')</a></li>
                            </ul>
                        </li>                               
                ...
                <li><a href="{{ route('admin.finance.index') }}" class="waves-effect"><i class="fa fa-money fa-fw"></i> <span class="hide-menu"> @lang('app.menu.finance') @if($unreadExpenseCount > 0) <div class="notify notification-color"><span class="heartbit"></span><span class="point"></span></div>@endif <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                        ...
                        @if(in_array("expenses", $modules))
                            ...
                            @endif
                            <!-- <li><a href="{{ route('admin.office-expenses.index') }}">@lang('app.menu.adminOfficeExpense')</a> </li> -->
                            <li><a href="{{ url('office-expenses') }}">@lang('app.menu.adminOfficeExpense')</a> </li>
