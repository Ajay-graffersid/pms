...
class ModuleSettingsController extends AdminBaseController
{
    ...
    // $moduleInPackage = (array)json_decode(company()->package->module_in_package);
       // array_push($moduleInPackage,"Bench");
   // echo '<pre>';print_r($moduleInPackage);die;
       $moduleInPackage = DB::table('modules')->pluck('module_name');;
     //  echo '<pre>';print_r($moduleInPackage1);die;
       ...
       // echo '<pre>';print_r($this->modulesData);die;
