...
use App\DataTables\Admin\EmployeesActiveDataTable;
use App\DataTables\Admin\EmployeesInactiveDataTable;
use App\DataTables\Admin\EmployeesbenchDataTable;
use App\Designation;
...
class ManageEmployeesController extends AdminBaseController
{
    ...
    public function index(EmployeesDataTable $dataTable)
    {
        ...
        $notAssignedProject = User::join('role_user', 'role_user.user_id', '=', 'users.id')
            ...
            ->select('users.id', 'users.name','users.status')->whereNotIn('users.id', function ($query) {
    ...
    {   //return 'aja';
        if (\request()->ajax()) {
            ...
            $freeEmployees = $whoseProjectCompleted->merge($notAssignedProject);
         //   echo 'pre>';print_r($freeEmployees);die;
     ...
     * @return \Illuminate\Http\Response
     */
    public function activeEmployees(EmployeesActiveDataTable $dataTable)
    {
        $this->pageTitle = 'app.menu.activeEmp';
        $this->employees = User::allEmployees();
        $this->skills = Skill::all();
        $this->departments = Team::all();
        $this->designations = Designation::all();
        ...
        $whoseProjectCompleted = ProjectMember::join('projects', 'projects.id', '=', 'project_members.project_id')
          ...
          //  echo '<pre>';print_r($whoseProjectCompleted);die;
    ...
    public function inactiveEmployees(EmployeesInactiveDataTable $dataTable)
    {
        $this->pageTitle = 'app.menu.inactiveEmp';
        $this->employees = User::allEmployees();
        $this->skills = Skill::all();
        $this->departments = Team::all();
        $this->designations = Designation::all();
    ...
    {
        $this->pageTitle = 'app.menu.batchEmp';
        if (\request()->ajax()) {
    ...
    public function benchEmployees(EmployeesbenchDataTable $dataTable)
    {
        $this->pageTitle = 'app.menu.batchEmp';
        $this->employees = User::allEmployees();
        $this->skills = Skill::all();
