...
use App\Currency;
use App\DataTables\Admin\OfficeExpensesDataTable;
...
class ManageOfficeExpensesController extends AdminBaseController
{
    ...
    public function index(OfficeExpensesDataTable $dataTable)
    {
      ...
      //  $this->employees = User::allEmployees();
       ...
       // echo '<pre>';print_r($this->data);die;
        return $dataTable->render('admin.office-expenses.index', $this->data);
    }
    ...
    public function demo(ExpensesDataTable $dataTable)
    {
      //  echo 'ajayyyyy';die;
       // echo '<pre>';print_r($dataTable);die;
        $this->employees = User::allEmployees();
        ...
        $this->categories = ExpensesCategory::all();
       // echo '<pre>';print_r($this->data);die;
        return $dataTable->render('admin.expenses.demo', $this->data);
    }
